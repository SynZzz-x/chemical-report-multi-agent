...
class AutonomousToolNode:
    ...
    def _evidence_context_for_generation(tool_calls: List[Dict[str, Any]]) -> str:
        ...
        return (
            ...
            "Every material quantitative, causal, priority/superlative, or strong operational assertion "
            "must carry an adjacent validated [E#] marker. Citations do not inherit across sentences or paragraphs. "
            "A material inference must cite the evidence used as its premise even when inference wording is explicit."
